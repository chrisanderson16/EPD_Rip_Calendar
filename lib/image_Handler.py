...
# ----- do i give it the image? yes
# ----- from here, all that needs to be done is have one large function
# 
# Mostly everything is already in functions, just need to consolidate them into one
